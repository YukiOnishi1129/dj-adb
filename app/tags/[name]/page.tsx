...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const description = `「${decodedName}」ジャンルの同人コミック・CG${tagWorks.length}作品を厳選レビュー。${ratingText}${saleText}${circleText}FANZAで人気の${decodedName}作品の評価・あらすじ・抜きどころを毎日更新。`.slice(0, 160);
        ...
        <Card className="mb-6 border-border">
          <CardContent className="p-5">
            <h1 className="text-xl font-bold text-foreground">
              #{decodedName} の同人コミック・CGおすすめ{sortedWorks.length}選
            </h1>
            ...
            <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
              「<span className="font-semibold text-foreground">{decodedName}</span>」ジャンルの同人コミック・CG作品
              ...
              FANZAで人気の{decodedName}ジャンル作品の評価・あらすじ・抜きどころを毎日更新中。
            </p>
          </CardContent>
        </Card>
